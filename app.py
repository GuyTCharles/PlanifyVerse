...
def generate_study_plan():
    ...
    prompt = (
        ...
        "Do not use double asterisks or Markdown formatting. Keep the entire plan as concise as possible (up to 500 tokens for concise or 1000 tokens for detailed plans).\n\n"
